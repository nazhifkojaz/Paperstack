...
UNIFIED_COLORS: list[UnifiedColor] = [
    {
        "hex": "#22c55e",
        "default_label": "Findings",
        "is_category": True,
        "category": "findings",
    },
    {
        "hex": "#3b82f6",
        "default_label": "Methods",
        "is_category": True,
        "category": "methods",
    },
    {
        "hex": "#a855f7",
        "default_label": "Definitions",
        "is_category": True,
        "category": "definitions",
    },
    {
        "hex": "#f97316",
        "default_label": "Limitations",
        "is_category": True,
...
DEFAULT_COLOR_LABELS: dict[str, str] = {
    c["hex"]: c["default_label"] for c in UNIFIED_COLORS
}
