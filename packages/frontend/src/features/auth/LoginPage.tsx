            ...
            <div className="w-full max-w-md px-6 py-12 flex flex-col items-center gap-8">
                ...
                <div className="w-full border border-border rounded-xl p-8 bg-card shadow-sm flex flex-col gap-4">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-3 w-full rounded-lg border border-border bg-background text-foreground py-3 px-4 font-medium text-sm hover:bg-muted transition-colors"
                    >
                        {/* GitHub SVG icon */}
                    ...
                    <p className="text-xs text-muted-foreground text-center">
                        Google stores PDFs in your Drive. GitHub uses a private repo.
                    </p>
                </div>
            </div>
        </div>
